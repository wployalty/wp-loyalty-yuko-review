...
class Input {
	...
	public static function get( string $var, $default = '', string $type = 'params', $sanitize = 'text' ) {
		...
		switch ( $type ) {
			...
			case 'post':
				//phpcs:ignore WordPress.Security.NonceVerification.Recommended, WordPress.Security.ValidatedSanitizedInput.MissingUnslash, WordPress.Security.ValidatedSanitizedInput.InputNotSanitized, WordPress.Security.NonceVerification.Missing
	...
	public static function sanitizeHtml( string $value ): string {
		return wp_kses( $value, (array) apply_filters( 'wlyr_allowed_html_elements_and_attributes', [
			'br'     => [],
			'strong' => [],
